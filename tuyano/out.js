...
(function dartProgram() {
  ...
  A = {
    main: function() {
      document.querySelector(".edit_sa_customer_question").textContent = "Hello Dart!";
    }
  };
  var holders = [J, P, W, H, A];
  ...
  (function inheritance() {
    ...
    _inheritMany(P.Object, [J.Interceptor, P.num, P.String]);
  })();
  var init = {
